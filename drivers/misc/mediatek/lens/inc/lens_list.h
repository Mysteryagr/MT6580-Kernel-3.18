...
#ifdef CONFIG_MTK_LENS_DW9713AF_SUPPORT
extern void DW9713AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long DW9713AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param);
extern int DW9713AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif
...
extern void DW9715AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened);
...
#ifdef CONFIG_MTK_LENS_DW9716AF_SUPPORT
extern void DW9716AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long DW9716AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param);
extern int DW9716AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif
