...
//#define //LOG_INF printk   // xlog_printk(ANDROID_//LOG_INFO   , PFX, "[%s] " format, __FUNCTION__, ##args)
...
static imgsensor_info_struct imgsensor_info = { 
    ...
    .pre = {
        .pclk = 42000000,              //record different mode's pclk //21
...
{    
	...
	write_cmos_sensor(0x2f,0x10); //pll clk 84M          
	write_cmos_sensor(0xfd,0x01);
