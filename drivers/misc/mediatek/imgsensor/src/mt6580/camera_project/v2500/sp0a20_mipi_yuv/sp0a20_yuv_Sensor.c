...
SP0A20_write_cmos_sensor(0xee,0x0c);
	...
	//d65 10
	SP0A20_write_cmos_sensor(0x66,0x28);
	SP0A20_write_cmos_sensor(0x67,0x4c);
	...
	//f   14
	SP0A20_write_cmos_sensor(0x61,0xd0);
	SP0A20_write_cmos_sensor(0x62,0xf8);
	SP0A20_write_cmos_sensor(0x63,0x44);
	SP0A20_write_cmos_sensor(0x64,0x78);
	...
	SP0A20_write_cmos_sensor(0xe8,0x28);//sharp_fac_pos 轮廓强度
	SP0A20_write_cmos_sensor(0xe9,0x28);
	SP0A20_write_cmos_sensor(0xea,0x20);
	SP0A20_write_cmos_sensor(0xeb,0x18);
SP0A20_write_cmos_sensor(0xec,0x28);//sharp_fac_neg
	SP0A20_write_cmos_sensor(0xed,0x28);
	SP0A20_write_cmos_sensor(0xee,0x24);
	SP0A20_write_cmos_sensor(0xef,0x1e);
	...
	SP0A20_write_cmos_sensor(0x71,0x08);//dns_edge_dif 弱轮廓（非平坦）区域平滑阈�? 0x81�?	
	SP0A20_write_cmos_sensor(0x72,0x08);
	SP0A20_write_cmos_sensor(0x73,0x0d);
...
SP0A20_write_cmos_sensor(0x79,0x45);//raw_flat_fac, raw_edge_fac  
SP0A20_write_cmos_sensor(0x7a,0x43);
...
//!F    
SP0A20_write_cmos_sensor(0xa0,0x84);
SP0A20_write_cmos_sensor(0xa1,0xfa);
SP0A20_write_cmos_sensor(0xa2,0xf5);
...
SP0A20_write_cmos_sensor(0xfd,0x02);
SP0A20_write_cmos_sensor(0xac,0x73);
SP0A20_write_cmos_sensor(0xad,0x0c);
SP0A20_write_cmos_sensor(0xae,0x00);
SP0A20_write_cmos_sensor(0xaf,0xda);
SP0A20_write_cmos_sensor(0xb0,0xc0);
SP0A20_write_cmos_sensor(0xb1,0xe7);
SP0A20_write_cmos_sensor(0xb2,0xd4);
SP0A20_write_cmos_sensor(0xb3,0xd4);
SP0A20_write_cmos_sensor(0xb4,0xd9);
SP0A20_write_cmos_sensor(0xb5,0x00);
SP0A20_write_cmos_sensor(0xb6,0x33);
SP0A20_write_cmos_sensor(0xb7,0x0f);
//sat u 
SP0A20_write_cmos_sensor(0xfd,0x01);
SP0A20_write_cmos_sensor(0xd3,0x68);
SP0A20_write_cmos_sensor(0xd4,0x68);
SP0A20_write_cmos_sensor(0xd5,0x60);
SP0A20_write_cmos_sensor(0xd6,0x60);
//sat v
SP0A20_write_cmos_sensor(0xd7,0x72);
SP0A20_write_cmos_sensor(0xd8,0x70);
...
SP0A20_write_cmos_sensor(0x14,0x9c);//kl_outdoor 
SP0A20_write_cmos_sensor(0x15,0x9c);//kl_nr      
SP0A20_write_cmos_sensor(0x16,0x98);//kl_dummy    
SP0A20_write_cmos_sensor(0x17,0x90);//kl_low   
