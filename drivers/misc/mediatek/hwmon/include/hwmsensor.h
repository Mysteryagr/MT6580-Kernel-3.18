...
#define SENSOR_TYPE_LIGHT_SUB            32
#define SENSOR_TYPE_PROXIMITY_SUB        33
#endif
...
#if defined(CONFIG_CUSTOM_KERNEL_ALSPS_SUB)
#define ID_LIGHT_SUB                                    (ID_BASE+SENSOR_TYPE_LIGHT_SUB-1)
#define ID_PROXIMITY_SUB                                (ID_BASE+SENSOR_TYPE_PROXIMITY_SUB-1)
#define ID_SENSOR_MAX_HANDLE	  (ID_BASE+SENSOR_TYPE_PROXIMITY_SUB)
#else
...
#if defined(CONFIG_CUSTOM_KERNEL_ALSPS_SUB)
#define SENSOR_LIGHT_SUB                    (1 << ID_LIGHT_SUB)
#define SENSOR_PROXIMITY_SUB                (1 << ID_PROXIMITY_SUB)
#endif
//@xucs added sub alsps sensor in 2016/01/19 end
/*----------------------------------------------------------------------------*/
...
#if defined(CONFIG_CUSTOM_KERNEL_ALSPS_SUB)
#define ALSPS_SUB_PL_DEV_NAME               "m_alsps_sub_pl"
#define ALSPS_SUB_INPUTDEV_NAME             "m_alsps_sub_input"
#define ALSPS_SUB_MISC_DEV_NAME             "m_alsps_sub_misc"
#endif
//@xucs added sub alsps sensor in 2016/01/19 end
...
#if defined(CONFIG_CUSTOM_KERNEL_ALSPS_SUB)
#define EVENT_SENSOR_LIGHT_SUB                  SENSOR_LIGHT_SUB
#define EVENT_SENSOR_PROXIMITY_SUB              SENSOR_PROXIMITY_SUB
#endif
//@xucs added sub alsps sensor in 2016/01/19 end
/*-----------------------------------------------------------------------------*/
