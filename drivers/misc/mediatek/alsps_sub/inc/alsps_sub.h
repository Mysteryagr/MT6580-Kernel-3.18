...
#ifndef __ALSPS_SUB_H__
#define __ALSPS_SUB_H__
...
#include "alsps_factory_sub.h"

#define ALSPS_TAG					"<ALS_SUB/PS> "
...
#define   OP_ALSPS_SUB_DELAY	0X01
#define	OP_ALSPS_SUB_ENABLE	0X02
#define	OP_ALSPS_SUB_GET_DATA	0X04

#define ALSPS_SUB_INVALID_VALUE -1

#define EVENT_TYPE_ALS_SUB_VALUE			ABS_X
#define EVENT_TYPE_PS_SUB_VALUE			REL_Z
#define EVENT_TYPE_ALS_SUB_STATUS		ABS_WHEEL
#define EVENT_TYPE_PS_SUB_STATUS			REL_Y


#define ALSPS_SUB_VALUE_MAX (32767)
#define ALSPS_SUB_VALUE_MIN (-32768)
#define ALSPS_SUB_STATUS_MIN (0)
#define ALSPS_SUB_STATUS_MAX (64)
#define ALSPS_SUB_DIV_MAX (32767)
#define ALSPS_SUB_DIV_MIN (1)


#define MAX_CHOOSE_ALSPS_SUB_NUM 5
...
struct alsps_sub_context {
	...
	struct alsps_sub_data	drv_data;
	struct als_sub_control_path	als_ctl;
	struct als_sub_data_path	als_data;
	struct ps_sub_control_path ps_ctl;
	struct ps_sub_data_path	ps_data;
...
/* AAL Functions */
extern int alsps_sub_aal_enable(int enable);
extern int alsps_sub_aal_get_status(void);
extern int alsps_sub_aal_get_data(void);

/* for auto detect */
extern int alsps_sub_driver_add(struct alsps_sub_init_info *obj);
extern int ps_sub_report_interrupt_data(int value);
...
extern int ps_sub_data_report(struct input_dev *dev, int value, int status);
extern int ps_sub_register_control_path(struct ps_sub_control_path *ctl);
extern int ps_sub_register_data_path(struct ps_sub_data_path *data);
extern struct platform_device *get_alsps_sub_platformdev(void);
#endif
